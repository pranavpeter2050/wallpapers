  ...
  <q-page>
    <div class="q-pa-lg">
      ...
      <p>
        ...
        other intellectual property rights related to it, still belong to Pranav
        Peter.
      </p>
      <p>
        Pranav Peter is committed to ensuring that the app is as useful and
      ...
      <p>
        The Wallpapers app stores and processes personal data that you have
        ...
        features and it could mean that the Wallpapers app won't work properly
        or at all.
      </p>
      <div>
        <p>
      ...
      <p>
        You should be aware that there are certain things that Pranav Peter will
        ...
        Wi-Fi or provided by your mobile network provider, but Pranav Peter
      ...
      <p>
        Along the same lines, Pranav Peter cannot always take responsibility for
        ...
        avail the Service, Pranav Peter cannot accept responsibility.
      </p>
      <p>
        With respect to Pranav Peter's responsibility for your use of the app,
        ...
        it available to you. Pranav Peter accepts no liability for any loss,
      ...
      <p>
        ...
        using the app. Pranav Peter does not promise that it will always update
      ...
      <p>These terms and conditions are effective as of 2023-03-22</p>
      <p><strong>Contact Us</strong></p>
      <p>
        If you have any questions or suggestions about my Terms and Conditions,
        do not hesitate to contact me at pranavpeter2050@gmail.com.
      </p>
      <p>
